...
import fr.epita.ratingmovies.config.Constants;
import fr.epita.ratingmovies.domain.MovieUser;
import fr.epita.ratingmovies.domain.User;
import fr.epita.ratingmovies.repository.MovieUserRepository;
import fr.epita.ratingmovies.repository.UserRepository;
import fr.epita.ratingmovies.security.AuthoritiesConstants;
import fr.epita.ratingmovies.service.MailService;
import fr.epita.ratingmovies.service.MovieUserService;
import fr.epita.ratingmovies.service.UserService;
import fr.epita.ratingmovies.service.dto.UserDTO;
import fr.epita.ratingmovies.web.rest.errors.BadRequestAlertException;
import fr.epita.ratingmovies.web.rest.errors.EmailAlreadyUsedException;
import fr.epita.ratingmovies.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public UserResource(MovieUserService movieUserService, MovieUserRepository movieUserRepository, UserService userService, UserRepository userRepository, MailService mailService) {
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody UserDTO userDTO) throws URISyntaxException {
        ...
        if (userDTO.getId() != null) {
            ...
            // Started : Create a user linked to the Jhipster User
            MovieUser movieUser = new MovieUser();
            movieUser.setUsername(newUser.getLogin());
            movieUserRepository.save(movieUser);
            // Ended : Create a user linked to the Jhipster User
