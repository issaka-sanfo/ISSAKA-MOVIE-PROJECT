...
public class UserService {
    ...
    public UserService(MovieUserRepository movieUserRepository, UserRepository userRepository, PasswordEncoder passwordEncoder, AuthorityRepository authorityRepository) {
    ...
    public Optional<User> getUserWithAuthoritiesByLogin(String login) {
        // Link Actual "User" to "MovieUser" if it exists and not linked by using the "Login"
