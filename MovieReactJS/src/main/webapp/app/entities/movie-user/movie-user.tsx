...
export const MovieUser = (props: IMovieUserProps) => {
  ...
  const { movieUserList, match, loading, totalItems } = props;
  return (
    <div>
            ...
            <tbody>
              {movieUserList.map((movieUser, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{movieUser.userLogin ? movieUser.userLogin : ''}</td>
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${movieUser.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      >
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${movieUser.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
                      >
      ...
      <div className={movieUserList && movieUserList.length > 0 ? '' : 'd-none'}>
...
const mapStateToProps = ({ movieUser }: IRootState) => ({
  ...
  totalItems: movieUser.totalItems
});
